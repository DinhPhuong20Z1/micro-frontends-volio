...
import { AddFolderData } from '../../../../../../src/app/@core/data/add-folder';
...
export class AddFolderComponent implements OnInit {
    ...
    constructor(
        ...
        private sourceTreeService: AddFolderData,
    ) { }
  ...
  dismiss() {
    ...
    callAddFolder(position, status, name) {
        ...
        this.sourceTreeService.postAddFolderData(formatName).subscribe(resp=> {
